...
export const LoginboxComponent = () => {
  return (
    <div className="mx-10 md:mx-[150px] lg:mx-[250px] my-36 lg:my-20 shadow-xl bg-white rounded-2xl flex flex-row">
      ...
      >
        ...
        <div className="flex flex-row ml-5 mb-[50px]">
          <input
            ...
            name=""
            id=""
            className="mx-2 outline-4 accent-green-400"
          />
          <p className="text-[12px] text-neutral-700 font-semibold">
      ...
      <div
        className="invisible lg:visible bg-green-400 rounded-r-2xl w-0 h-[500px]
      ...
      >
        ...
        >
          ...
          className="overflow-clip ml-10 pt-16" />
        </div>
      </div>
    </div>
  );
